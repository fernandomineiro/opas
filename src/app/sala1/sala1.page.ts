...
export class Sala1Page implements OnInit {
    ...
    if (parseInt(this.data.cartela) <= 1) {
      ...
      if (this.data.saldo < res) {
        ...
        for (var a = 0; a < this.data.tantascartela; a++) {
          ...
          this.data.safraa.push(this.data.zz);
          this.data.safraaa.push(this.data.zzz);
          this.data.safra.push(this.data.x);
          this.data.safraa.push(this.data.xx);
          this.data.safraaa.push(this.data.xxx);
          this.data.safra.push(this.data.c);
          this.data.safraa.push(this.data.cc);
          this.data.safraaa.push(this.data.ccc);
          this.data.safra.push(this.data.v);
          this.data.safraa.push(this.data.vv);
          this.data.safraaa.push(this.data.vvv);
          this.data.safra.push(this.data.b);
          this.data.safraa.push(this.data.bb);
  ...
  async traz() {
    for (var z = 1; z <= 90; z++) {
      ...
      this.data.sorteadas = this.data.sorteadas;
      if (this.data.bolas.indexOf(this.data.bola) > -1) {
  ...
  cartelao() {
    ...
    if (this.data.xss > 30 && this.data.xsss <= 40) {
      this.data.vela[3] = this.data.xss;
    }
    if (this.data.xsss > 40 && this.data.xsss <= 50) {
      this.data.vela[4] = this.data.xsss;
    ...
    if (this.data.xsssss > 70 && this.data.xssss <= 80) {
      this.data.vela[8] = this.data.xsssss;
    }
    if (this.data.xsssss > 80) {
      this.data.vela[9] = this.data.xsssss;
    }
    ...
    if (this.data.zss > 30 && this.data.zsss <= 40) {
      this.data.vela[13] = this.data.zss;
    }
    if (this.data.zsss > 40 && this.data.zsss <= 50) {
      this.data.vela[14] = this.data.zsss;
    ...
    if (this.data.zsssss > 70 && this.data.zssss <= 80) {
      this.data.vela[18] = this.data.zsssss;
    }
    if (this.data.zsssss > 80) {
      this.data.vela[19] = this.data.zsssss;
    }
    if (this.data.cs <= 10) {
    ...
    if (this.data.css > 30 && this.data.csss <= 40) {
      this.data.vela[23] = this.data.css;
    }
    ...
    if (this.data.csssss > 70 && this.data.cssss <= 80) {
      this.data.vela[28] = this.data.csssss;
    }
    if (this.data.csssss > 80) {
      this.data.vela[29] = this.data.csssss;
    }
  }
  ...
  async linha() {
    ...
    if (this.data.numerolinha.length != 0) {
      ...
      this.data.saldo = + this.data.plinha;
          ...
          for (var cc = 0; cc < this.data.bolas.length; cc++) {
            if (this.data.serie[tt][zz][xx] == this.data.bolas[cc]) {
              ...
              if (this.data.ponto == 15) {
                ...
                this.data.saldo = this.data.saldo + this.data.pbingo;
