(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~central-central-module~sala1-sala1-module"], {
    /***/
    ...
    /***/
    function srcAppServicesAxiosServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AxiosService", function () {
        return AxiosService;
      });
      /* harmony import */
      ...
      var AxiosService = function AxiosService() {
        _classCallCheck(this, AxiosService);

        this.axios = axios__WEBPACK_IMPORTED_MODULE_2___default.a.create({
          baseURL: src_config__WEBPACK_IMPORTED_MODULE_3__["default"].baseURL
        });
      };

      AxiosService.ctorParameters = function () {
        return [];
      };

      AxiosService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], AxiosService);
      /***/
    },
...
//# sourceMappingURL=default~central-central-module~sala1-sala1-module-es5.js.map